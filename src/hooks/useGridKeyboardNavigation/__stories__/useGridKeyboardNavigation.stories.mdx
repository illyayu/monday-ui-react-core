...
<FunctionArguments>
  <FunctionArgument name="result" type="Object">
    ...
    <FunctionArgument
      ...
      description={<>The <code>onFocus</code> handler which should be injected to the element which <code>ref</code> is referring to.</>}
    />
    <FunctionArgument
      name="onBlur"
      type="React.FocusEventHandler<HTMLElement>"
      description={<>The <code>onBlur</code> handler which should be injected to the element which <code>ref</code> is referring to.</>}
    />
  </FunctionArgument>
</FunctionArguments>
